...
export default function Contact() {
  ...
  return (
    <div className="min-h-screen bg-background flex flex-col">
      <SEO 
        title="Contact Us" 
        description="Get in touch with Luminary Communications. We're here to help you build a narrative that matters and a reputation that lasts."
        keywords="contact Luminary, communications agency Nairobi, PR inquiries"
      />
      <Navigation />
